        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    $cartItems = getCartItems(generateSessionId());
                    ...
                    <a href="ajout-au-panier.php" class="text-gray-700 hover:text-amber-600 relative">
                        ...
                        <?php if ($cartCount > 0): ?>
                        <span class="absolute -top-2 -right-2 bg-amber-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center"><?php echo $cartCount; ?></span>
                        <?php endif; ?>
                    </a>
